...
namespace Projet_pilate.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        //
        // GET: /Manage/Index
        [Route("Manage/Index", Name = "GestionCompte")]
        ...
        [AllowAnonymous]
        [Route("Manage/ChangeEmail", Name = "ChangeEmail")]
        public ActionResult ChangeEmail(string id = null)
        {
            string userId = null;

            // Seul le profil "Administrator" peut passer un paramètre "id" à l'URL 
            if (id != null && User.IsInRole("Administrateur"))
            {
                userId = id;
            }
            else
            ...
            UpdateEmailViewModel vm = new UpdateEmailViewModel();
            vm.Id = user.Id;
            vm.Email = user.Email;
        ...
        [HttpPost]
        [Route("Manage/ChangeEmail")]
        public ActionResult ChangeEmail(UpdateEmailViewModel model)
        {
            ApplicationDbContext db = new ApplicationDbContext();

            //Vérifie dans un premier temps que  l'email renseigné correspond au champ "username" de la table dbo.user
            //UserName est un champ contenant les emails d'utilisateur.
            var user = db.Users.SingleOrDefault(x => x.UserName == model.Email);
        ...
        // GET: /Manage/UpdatePassword
        [Authorize(Roles = "Administrateur")]
        [Route("Manage/UpdatePassword", Name = "UpdatePassword")]
        ...
        // POST: /Manage/UpdatePassword
        [HttpPost]
        [Authorize(Roles = "Administrateur")]
        [Route("Manage/UpdatePassword")]
        public async Task<ActionResult> UpdatePassword(UpdatePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                var save = await UserManager.AddPasswordAsync(model.Id, model.NewPassword);
            ...
            return View("SuccessPassword", User);
        }


        // GET: /Manage/SuccessPassword
        ...
        // GET: /Manage/CreateUserList
        [Route("Manage/CreateUserConsultantList", Name = "CreateUserConsultantList")]
        public ActionResult CreateUserConsultantList()
        {
            ApplicationDbContext db = new ApplicationDbContext();
            List<DetailConsultantViewModel> models = new List<DetailConsultantViewModel>();

            var consultants = db.Consultants.Where(c => c.UserID == null);
        ...
        // GET: /Manage/ManagerList
        [Route("Manage/CreateUserManagerList", Name = "CreateUserManagerList")]
        public ActionResult CreateUserManagerList()
        {
            ApplicationDbContext db = new ApplicationDbContext();
            List<DetailManagerViewModel> models = new List<DetailManagerViewModel>();

            var managers = db.Managers.Where(c => c.UserID == null);
